...
{
    /// <summary>
    /// The Least Squares Moving Average (LSMA) calculates a least squares regression line
    /// over the preceding time periods and projects it forward to the current period.
    /// Optionally supports a benchmark symbol for relative regression.
    /// </summary>
    public class LeastSquaresMovingAverage : WindowIndicator<IndicatorDataPoint>, IIndicatorWarmUpPeriodProvider
    {
        ...
        /// <summary>
        /// The benchmark symbol (optional)
        /// </summary>
        public Symbol Benchmark { get; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LeastSquaresMovingAverage"/> class
        /// with a specified benchmark symbol.
        /// </summary>
        public LeastSquaresMovingAverage(string name, int period, Symbol benchmark)
            : base(name, period)
        {
            _t = Vector<double>.Build.Dense(period, i => i + 1).ToArray();
            Intercept = new Identity(name + "_Intercept");
        ...
        /// with a specified benchmark symbol.
        /// </summary>
        public LeastSquaresMovingAverage(int period, Symbol benchmark)
            : this($"LSMA({period})", period, benchmark)
        {
        }
